  ...
  return (
    <div className="bg-primary-50 min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-8">
        ...
        <div className="bg-white rounded-sm border border-black/5 p-4 sm:p-6 md:p-8 shadow-sm space-y-8 md:space-y-10 text-[14px] leading-relaxed text-primary-950/80">
          
          {/* 1. Return Process (moved to the top) */}
          <section className="space-y-3.5 md:space-y-4">
            <div className="flex items-center gap-3 text-primary-950 border-b border-black/5 pb-2">
               ...
               <h2 className="text-xl font-serif">1. The Return Process</h2>
            </div>
            <div className="grid sm:grid-cols-3 gap-6 pt-2">
              <div className="space-y-1.5 md:space-y-2">
                <div className="font-bold text-gold-600 text-base md:text-lg">Step 1</div>
                <div className="font-semibold text-primary-950">Raise a Request</div>
                <p className="text-[13px] text-primary-950/75">Contact our support team within 7 days. Provide your Order ID and clear photographs of the product.</p>
              </div>
              <div className="space-y-1.5 md:space-y-2">
                <div className="font-bold text-gold-600 text-base md:text-lg">Step 2</div>
                <div className="font-semibold text-primary-950">Approval & Pickup</div>
                <p className="text-[13px] text-primary-950/75">Once approved (typically 24-48 hours), we will arrange a return pickup from your delivery address.</p>
              </div>
              <div className="space-y-1.5 md:space-y-2">
                <div className="font-bold text-gold-600 text-base md:text-lg">Step 3</div>
                <div className="font-semibold text-primary-950">Inspection & Refund</div>
                <p className="text-[13px] text-primary-950/75">After the product reaches our warehouse, it passes quality checks, followed by the initiation of your refund or exchange.</p>
              </div>
            </div>
          </section>
          ...
          <section className="border border-neutral-200 rounded-sm overflow-hidden bg-neutral-50/50 transition-all duration-300">
            <button
              ...
              className="w-full bg-primary-950 text-white hover:bg-primary-950/95 px-5 py-3 sm:py-3.5 flex items-center justify-between text-left transition-colors"
            >
              <div className="flex items-center gap-2 md:gap-3">
                <FileText className="text-gold-400 shrink-0" size={18} />
                <span className="text-sm sm:text-base tracking-[0.08em] font-medium uppercase font-serif">Request a Return</span>
              </div>
              <div className="shrink-0">
                {isFormExpanded ? <ChevronUp size={16} className="text-gold-200" /> : <ChevronDown size={16} className="text-gold-200" />}
              </div>
            </button>

            {isFormExpanded && (
              <div className="p-4 sm:p-5 md:p-6 bg-white border-t border-neutral-100 transition-all duration-500">
                <h3 className="text-base font-serif text-primary-950 mb-0.5 border-b border-neutral-100 pb-1.5 flex items-center gap-2">
                  <span>Return Request Form</span>
                </h3>
                <p className="text-primary-950/60 text-xs mb-4">
                ...
                {submitted ? (
                  <div className="text-center py-6 px-4 border border-emerald-100 bg-emerald-50/30 rounded-sm mb-2">
                    <CheckCircle2 className="mx-auto text-emerald-600 mb-2" size={36} />
                    <h4 className="text-base font-serif text-primary-950 font-medium mb-1">Submission Successful</h4>
                    <p className="text-emerald-850 text-xs max-w-sm mx-auto leading-relaxed font-semibold">
                      Your return request has been submitted successfully. Our team will contact you shortly.
                    </p>
                    <button
                      onClick={() => setSubmitted(false)}
                      className="mt-4 text-xs text-primary-950 hover:text-gold-600 underline font-semibold uppercase tracking-wider"
                    >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-[10.5px] sm:text-[11px] font-bold uppercase tracking-wider text-primary-950/70 mb-1">
                        ...
                        <input
                          ...
                          className={`w-full bg-neutral-50 px-3.5 py-2.5 border focus:outline-none focus:bg-white text-xs tracking-wider transition-colors placeholder:text-neutral-400 ${
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <div className="flex flex-col">
                          <div className="flex">
                            <span className={`inline-flex items-center px-2.5 bg-neutral-100 border border-r-0 text-neutral-500 text-xs select-none font-sans ${
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className={`w-full bg-neutral-50 px-3.5 py-2.5 border focus:outline-none focus:bg-white text-xs tracking-wider transition-colors ${
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full bg-neutral-50 px-3.5 py-2.5 border border-neutral-200 focus:outline-none focus:border-[#C8A96B] focus:bg-white text-xs tracking-wider transition-colors placeholder:text-neutral-400 resize-none"
                      />
                    </div>
                    ...
                    <div className="pt-1">
                      <button
                        type="submit"
                        disabled={submitting}
                        className="w-full bg-[#1A1A1A] hover:bg-[#C8A96B] text-white hover:text-[#1A1A1A] py-2.5 sm:py-3 text-[11px] sm:text-xs font-bold uppercase tracking-widest transition-all duration-300 disabled:bg-neutral-350 disabled:text-neutral-500 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-sm font-sans"
                      >
                        {submitting ? (
                          <>
                ...
                <div className="mt-6 pt-4 border-t border-neutral-100 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs tracking-wider">
          ...
          <section className="space-y-3.5 md:space-y-4">
            <div className="flex items-center gap-3 text-primary-950 border-b border-black/5 pb-2">
               ...
               <h2 className="text-xl font-serif">2. Return Eligibility & Timeline</h2>
            </div>
            <p>
          ...
          <section className="space-y-3.5 md:space-y-4">
            <div className="flex items-center gap-3 text-primary-950 border-b border-black/5 pb-2">
               ...
               <h2 className="text-xl font-serif">3. Product Condition Requirements</h2>
            </div>
          ...
          <section className="space-y-3.5 md:space-y-4">
            <div className="flex items-center gap-3 text-primary-950 border-b border-black/5 pb-2">
               ...
               <h2 className="text-xl font-serif">4. Non-Returnable Items</h2>
            </div>
          ...
          <section className="space-y-4 bg-primary-50 p-5 md:p-6 rounded-sm">
            ...
            <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-5">
              <div className="space-y-1">
                ...
                <p className="mt-1 text-[13px] text-primary-950/75">In standard return scenarios, a nominal return shipping fee may be deducted from your refund amount. For defective or incorrect items, the return is entirely free of charge.</p>
              </div>
              
              <div className="space-y-1">
                <h3 className="font-semibold text-primary-950 text-[14px]">Can I cancel my order?</h3>
                <p className="mt-1 text-[13px] text-primary-950/75">Orders can only be canceled if they have not yet been dispatched from our warehouse. Please contact support immediately if you wish to cancel an order.</p>
              </div>

              <div className="space-y-1">
                <h3 className="font-semibold text-primary-950 text-[14px]">What happens if return pickup is unavailable?</h3>
                <p className="mt-1 text-[13px] text-primary-950/75">If return pickup service is unavailable at your pincode, you can self-ship. We will fully reimburse standard shipping costs upon receiving the receipt.</p>
              </div>
            </div>
          </section>
