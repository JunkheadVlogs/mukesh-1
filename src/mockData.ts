...
Style this premium Fendy Space Silk Saree with a high-contrast silk blouse, statement chandelier earrings, matching heels, and elegant makeup for the perfect Bollywood-inspired diva ensemble.`,
  ...
  },
  {
    ...
    isHidden: true,
    description: `**DESCRIPTION:**
This is a secure, hidden payment testing product configured specifically for live environment transaction validation, gateway handshake verification, and performance fine-tuning. This token has a nominal value of ₹1 and enables administrators to complete safe, end-to-end checkout loop validation.
